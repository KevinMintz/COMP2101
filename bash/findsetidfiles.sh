#!/bin/bash
#
# this script generates a report of the files on the system that have the setuid bit turned on
...
#   be displayed after the listing of the setuid files
#   should have it's own title, similar to how the setuid files listing has a title
...
echo "================"
find / -type f -ls 2>/dev/null | ls -laSh ~/ |awk '{print $1,$3,$5}' | head -12
